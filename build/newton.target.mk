...
$(builddir)/newton.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/newton.node: LIBS := $(LIBS)
$(builddir)/newton.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/newton.node: TOOLSET := $(TOOLSET)
$(builddir)/newton.node: $(OBJS) FORCE_DO_CMD
...
.PHONY: newton.node
newton.node: $(builddir)/newton.node
